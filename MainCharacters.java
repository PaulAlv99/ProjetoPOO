...
public class MainCharacters extends Actor
{
   ...
   boolean onBloco()
   {
    Actor under = getOneObjectAtOffset(0,getImage ().getHeight()/2,Bloco.class);
    return under!=null;
   }
   ...
   public void checkFalling()
   {
    ...
    // public void checkCollisionWithBloco(){
        // if(vSpeed>0){
